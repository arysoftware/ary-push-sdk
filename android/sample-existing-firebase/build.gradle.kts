...
android {
    namespace = "com.ary.push.samplefb"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.ary.push.samplefb"
        minSdk = 21
        targetSdk = 36
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // This sample models an application that already used Firebase Messaging directly before
    // the SDK arrived, and keeps its own FirebaseMessagingService.

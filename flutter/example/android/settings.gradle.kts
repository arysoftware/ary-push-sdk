...
plugins {
    ...
    // Declared so the app can apply it the moment a google-services.json is dropped in. Not
    // applied here: Firebase configuration belongs to the host application, and this
    // repository deliberately contains none.
